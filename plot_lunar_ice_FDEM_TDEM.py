...
### FD ### FD### FD### FD### FD### FD### FD### FD### FD ### FD ### FD### FD### FD### FD### FD### FD### FD### FD
	...
	plt.plot(f, np.abs(-Qppm_c), '--', linewidth=2, markersize=10, color = plotcolors[ikx+2], marker=mrk[y+2], markevery=markerspace[y+i+ikx+2], label=r'Full model. Q. %.45s at %.1d K' %(subsurf2.name, (subsurf2.T + 273 )))
