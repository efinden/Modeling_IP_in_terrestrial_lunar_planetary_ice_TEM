...
def halfspace_and_3layers_tem(depth, subsurf1, subsurf2, subsurf3, radius, I, Nr, a_rec, Tx_geometry,  Rx_config, normalization, filter_ft, filter_ht, hTx, hRx, custom_LPF, output_H_or_EMF, soln_type):
...
#		ht_filter = 'cos-filter
	...
	return off_time, times, out_custom, out_step_off, radius, waveform_times[-1], Ar, Nr, I, soln_type, ylabeltext, noise, noiselabel
